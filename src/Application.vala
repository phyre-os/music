...
public class Music.Application : Gtk.Application {
    ...
    protected override void startup () {
        ...
        gtk_settings.gtk_theme_name = "io.phyre.stylesheet.orange";
    ...
    protected override void activate () {
        ...
        var mpris_id = Bus.own_name (
            BusType.SESSION,
            "org.mpris.MediaPlayer2.io.phyre.music",
        ...
        */
        var settings = new Settings ("io.phyre.music");
